...
server.tool("ask_user", `Ask the user 1-4 questions and wait for replies. Delivered via OpenClaw to their messaging app.
...
Omit options for free-text. The user always has an implicit "Other" option.`, {
    ...
    return { content: [{ type: "text", text: formatResult(result, questions) }] };
});
server.tool("notify_user", "Send a notification to the user without waiting for a reply.", {
